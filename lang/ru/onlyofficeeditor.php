...
$string['download_desc'] = 'Разрешить скачивание документов с помощью приложения ONLYOFFICE editor';
...
$string['print_desc'] = 'Разрешить печать документов с помощью приложения ONLYOFFICE editor';
...
$string['protect_desc'] = 'Разрешить пользователям открывать вкладку защиты в приложении ONLYOFFICE editor';
...
$string['privacy:metadata:onlyofficeeditor:intro'] = 'Общее представление об элементах ONLYOFFICE';
