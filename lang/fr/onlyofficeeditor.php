...
$string['allowedformats'] = 'Formats autorisés';
...
$string['printintro'] = 'Imprimer le texte d'introduction';
...
$string['download_desc'] = 'Permettre le téléchargement de documents via l'application de l'éditeur ONLYOFFICE';
...
$string['print_desc'] = 'Permettre l'impression de documents via l'application de l'éditeur ONLYOFFICE';
...
$string['protect_desc'] = 'Permettre aux utilisateurs d'ouvrir l'onglet de protection dans l'application d'édition ONLYOFFICE';
